function validate_co_nit(nit: string, debug: boolean = false): boolean {
    ...
    function weightedSum(number: string, config: { weights?: number[]; modulus?: number; reverse?: boolean }) {
