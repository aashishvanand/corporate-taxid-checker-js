...
function validate_in_gst(gst: string, debug: boolean = false): boolean {
...
function validate_in_pan(pan: string, debug: boolean = false): boolean {
...
export { validate_in_gst, validate_in_pan };
